...
class TriggerHotkeyLauncher(ActionLauncher):
    ...
    def getIcon(self):
        return readPNGIcon(ROOT_DIRECTORY + "/assets/icons/actions/general/shortcut.png")
    ...
    def getActionUI(self, controlType: str) -> Tuple[str, str]:
        return UI_TYPE_QTUI, \
               icontools.encodeIconData(
                   filewriter.readFileBinary(ROOT_DIRECTORY + "/assets/ui/actions/general/triggerhotkey.ui"))
    #endregion