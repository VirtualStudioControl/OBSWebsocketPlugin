from obswebsocketplugin.actions.sources.setfiltervalue.fader_setfiltervalue import FaderSetFilterValue
from obswebsocketplugin.actions.sources.setfiltervalue.rotaryencoder_setfiltervalue import RotarySetFilterValue
...
class SetCurrentSceneLauncher(ActionLauncher):
    ...
    def getIcon(self):
        return readPNGIcon(ROOT_DIRECTORY + "/assets/icons/actions/sources/filter.png")
    ...
    def getActionUI(self, controlType: str) -> Tuple[str, str]:
        return UI_TYPE_QTUI, \
               icontools.encodeIconData(
                   filewriter.readFileBinary(ROOT_DIRECTORY + "/assets/ui/actions/source/setfiltervalue.ui"))
    #endregion